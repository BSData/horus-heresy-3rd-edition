...
* Create a new category for this slot.
...
* * Not listing the original category is important because this unit should not be able to select a prime.
* Add this new category to every relevant detachment (any detachment with primes).
